...
%%
[Spline_fields,LES] = compute_function_using_beta_pdf(Spline_fields,"Comb",LES,'type','dfdc_rz','epsilon',1e-2);
[Spline_fields,LES] = compute_function_using_beta_pdf(Spline_fields,"Noz",LES,'type','dfdc_rz','epsilon',1e-2);
%% Normalize fields
