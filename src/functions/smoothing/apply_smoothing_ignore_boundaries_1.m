function smoothed_data = apply_smoothing_ignore_boundaries_1(data, window, ignore_boundaries, boundary_width, N_smoothing_itr)
...
smoothed_interior_data = interior;

% Apply smoothing to interior
for i = 1:N_smoothing_itr
    smoothed_interior_data = apply_smoothing_1(smoothed_interior_data, window);
end
