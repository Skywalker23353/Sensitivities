function [Spline_fields] = fit_spline_for_C_cond_data(Spline_fields,GridName,field_names, path, C_MAT)
    ...
    for i = 1:length(field_names)
        ...
        if ismember(field_name, {'Heatrelease','SYm_CH4','SYm_CH2O','SYm_CH3','SYm_CO', 'SYm_O2', 'SYm_CO2', 'SYm_H2O', 'SYm_H2', 'SYm_H', 'SYm_HO2', 'SYm_O', 'SYm_OH'})
        ...
        Spline_fields.(field_name).(GridName).pp = pp;
        Spline_fields.(field_name).(GridName).dpp = dpp;
        clear field dpp pp;
    end
end
